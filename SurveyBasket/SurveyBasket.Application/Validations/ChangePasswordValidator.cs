    ...
    public class ChangePasswordValidator : AbstractValidator<ChangePasswordRequest>
    {
        public ChangePasswordValidator() 
        {
            ...
            RuleFor(x => x.NewPassword)
                ...
                .Matches(RegexPatterens.PasswordPattern).WithMessage("New password should be at least 8 characters and should contain lowercase, uppercase, digit, and special character.")
